...
val cryodist = Builder.start(loc, id)
    .withPattern(
        FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.BACK, RelativeDirection.UP)
            ...
            .where('S', <metastate:gregtech:metal_casing_steel>)
            .whereOr('F', <metastate:gregtech:metal_casing_aluminium> as IBlockMatcher,
    ...
    .addDesign(
        FactoryMultiblockShapeInfo.start()
            ...
            .where('~', IBlockInfo.EMPTY)
            .where('F', <gregtech:metal_casing_aluminium>)
            .where('S', <gregtech:metal_casing_steel>)
    ...
    .withRecipeMap(
        FactoryRecipeMap.start(loc)
                        ...
                        .maxFluidOutputs(6)
                        .build())
    .withTexture(<gregtech:metal_casing_aluminium> as IBlock as ICubeRenderer)
...
val microverse_casing = <metastate:contenttweaker:microverse_casing>;
val microverse_vent = <metastate:contenttweaker:microverse_vent>;
...
val small_microverse = Builder.start(loc, id)
    .withPattern(
        FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.DOWN, RelativeDirection.FRONT)
            ...
            .where('V', microverse_vent)
            .where('*', <extendedcrafting:compressor>)
            .whereOr('C', microverse_casing as IBlockMatcher,
                            IBlockMatcher.abilityPartPredicate(MultiblockAbility.INPUT_ENERGY,
                                                                MultiblockAbility.IMPORT_FLUIDS,
    ...
    .withRecipeMap(
        FactoryRecipeMap.start(loc)
                        ...
                        .build())
    .withTexture(ICubeRenderer.fromState(microverse_casing))
    .buildAndRegister() as Multiblock;
...
val large_microverse = Builder.start(loc, id)
    ...
    .withRecipeMap(
        FactoryRecipeMap.start(loc)
                        ...
                        .setProgressBar(ROCKET_ARROW, MoveType.HORIZONTAL)
                        .build())
    .withTexture(microverse_casing as ICubeRenderer)
    .buildAndRegister() as Multiblock;
...
craft.makeShaped("multiblock_controller_base", <gregtech:machine:3000>,
	["CMC",
	 "MSM",
	 "CMC"],
	{ C : gt.getCirc("HV"),
	  M : <gregtech:metal_casing:3>, //Frost Proof Machine Casing
	  S : <extrautils2:screen> } as IIngredient[string]
);

// Small Microverse Projector

craft.makeShaped("small_microverse_controller", <gregtech:machine:3001>,
    ["CBC",
     "BSB",
     "CBC"],
    { C : gt.getCirc("HV"), //T3
...
craft.makeShaped("medium_microverse_controller", <gregtech:machine:3002>,
    ["CBC",
     "BSB",
     "CBC"],
    { C : gt.getCirc("EV"), //T4
...
craft.makeShaped("large_microverse_controller", <gregtech:machine:3003>,
    ["CBC",
     "BSB",
     "CBC"],
    { C : gt.getCirc("IV"), //T5
...
craft.makeShaped("oil_drilling_rig", <gregtech:machine:3004>,
    ["CBC",
     "BSB",
     "FPF"],
    { C : gt.getCirc("HV"), //T3
      ...
      P : <inspirations:pipe>,
      F : <gregtech:frame_steel>} as IIngredient[string]);

// Naquadah Reactor MK 1

craft.makeShaped("naquadah_reactor_1", <gregtech:machine:3005>,
    ["NCN",
     "GSG",
     "PPP"],
    { C : gt.getCirc("IV"), //T5
      ...
      N : <extendedcrafting:material:33>} as IIngredient[string]); //Omnium Nugget

// Naquadah Reactor MK 2

craft.makeShaped("naquadah_reactor_2", <gregtech:machine:3006>,
    ["NCN",
     "GSG",
     "PPP"],
    { C : gt.getCirc("LuV"), //T6
      ...
      S : <extrautils2:screen>,
      P : <appliedenergistics2:spatial_pylon>,
      N : <extendedcrafting:material:32>} as IIngredient[string]); //Omnium Ingot

// Lunar Mining Station

craft.makeShaped("lunar_mining_station", <gregtech:machine:3007>,
    ["CLC",
     "LSL",
     "CLC"],
    { C : gt.getCirc("EV"), //T4
...
small_microverse.recipeMap
    ...
    .outputs(<ore:gemExquisiteEmerald>.firstItem * 16,
             <ore:gemExquisiteEmerald>.firstItem * 16,
             <gregtech:meta_item_2:25111> * 16,
             <gregtech:meta_item_2:25111> * 16,
             <gregtech:meta_item_2:25111> * 16,
             <gregtech:meta_item_2:25111> * 16,
