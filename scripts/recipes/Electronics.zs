...
recipes.addShaped(<gregtech:machine:101>, [
	[<metaitem.robot.arm.mv>, <ore:circuitAdvanced>, <metaitem.robot.arm.mv>], 
	[<gregtech:meta_item_1:32631>, <meta_tile_entity:gregtech:hull.mv>, <gregtech:meta_item_1:32631>], 
...
assembly_line.recipeBuilder().inputs([<metaitem:component.smd.resistor> * 32, <metaitem:plate.power_integrated_circuit> * 8, <metaitem:component.smd.transistor> * 24, <metaitem:component.smd.capacitor> * 28, <metaitem:component.smd.diode> * 16, <metaitem.quantumstar>, <contenttweaker:quantumprocessorarray> * 2, <gregtech:frame_hssg> * 4, <ore:wireGtSingleSignalum> * 8]).fluidInputs(<liquid:soldering_alloy> * 1440).outputs([<contenttweaker:quantumprocessormainframe>]).duration(500).EUt(8000).buildAndRegister();
...
assembly_line.recipeBuilder().inputs(<gregtech:meta_item_2:32459> * 32, <gregtech:meta_item_1:19391> * 32, <gregtech:meta_item_2:32460> * 32, <gregtech:meta_item_2:32458> * 16, <gregtech:meta_item_2:32457> * 16, <ore:plateEuropium> * 4, <gregtech:cable:354> * 8, <gregtech:meta_item_2:32499> * 2, <enderio:item_material:44> * 8).fluidInputs(<liquid:soldering_alloy> * 1152).outputs(<gregtech:meta_item_2:32500>).duration(600).EUt(122880).buildAndRegister();
...
recipes.addShapeless(<gregtech:cable:5071>, [<gregtech:cable:71>,<ore:plateRubber>]);		//tin
recipes.addShapeless(<ore:cableGtSingleRedAlloy>, [<gregtech:cable:237>,<ore:plateRubber>]);		//red alloy
recipes.addShapeless(<gregtech:cable:5018>, [<gregtech:cable:18>,<ore:plateRubber>]);		//copper

//Rubber by hand
recipes.addShaped(<ore:plateRubber>,[[<gregtech:meta_tool:6>],[<metaitem:rubber_drop>],[<metaitem:rubber_drop>]]);	
...
//x4 LV ceu
recipes.addShaped(<gregtech:machine:10660>, [[<ore:wireGtQuadrupleConductiveIron>, gt.getCirc("LV"), <ore:wireGtQuadrupleConductiveIron>], [<enderio:item_power_conduit>, <meta_tile_entity:gregtech:hull.lv>, <enderio:item_power_conduit>], [<ore:wireGtQuadrupleConductiveIron>, <ore:chestWood>, <ore:wireGtQuadrupleConductiveIron>]]);
//x4 LV cef
recipes.addShaped(<gregtech:machine:10661>, [[<enderio:item_power_conduit>, gt.getCirc("LV"), <enderio:item_power_conduit>], [<ore:wireGtQuadrupleConductiveIron>, <meta_tile_entity:gregtech:hull.lv>, <ore:wireGtQuadrupleConductiveIron>], [<enderio:item_power_conduit>, <ore:chestWood>, <enderio:item_power_conduit>]]);
//x16 LV ceu
recipes.addShaped(<gregtech:machine:10664>, [[<ore:wireGtHexConductiveIron>, gt.getCirc("LV"), <ore:wireGtHexConductiveIron>], [<enderio:item_power_conduit>, <meta_tile_entity:gregtech:hull.lv>, <enderio:item_power_conduit>], [<ore:wireGtHexConductiveIron>, <ore:chestWood>, <ore:wireGtHexConductiveIron>]]);
//x16 LV cef
recipes.addShaped(<gregtech:machine:10665>, [[<enderio:item_power_conduit>, gt.getCirc("LV"), <enderio:item_power_conduit>], [<ore:wireGtHexConductiveIron>, <meta_tile_entity:gregtech:hull.lv>, <ore:wireGtHexConductiveIron>], [<enderio:item_power_conduit>, <ore:chestWood>, <enderio:item_power_conduit>]]);
...
//x4 MV ceu
recipes.addShaped(<gregtech:machine:10668>, [[<ore:wireGtQuadrupleEnergeticAlloy>, <ore:circuitGood>, <ore:wireGtQuadrupleEnergeticAlloy>], [<enderio:item_power_conduit:1>, <meta_tile_entity:gregtech:hull.mv>,<enderio:item_power_conduit:1>], [<ore:wireGtQuadrupleEnergeticAlloy>, <ore:chestWood>, <ore:wireGtQuadrupleEnergeticAlloy>]]);
//x4 MV cef
recipes.addShaped(<gregtech:machine:10669>, [[<enderio:item_power_conduit:1>, <ore:circuitGood>, <enderio:item_power_conduit:1>], [<ore:wireGtQuadrupleEnergeticAlloy>, <meta_tile_entity:gregtech:hull.mv>, <ore:wireGtQuadrupleEnergeticAlloy>], [<enderio:item_power_conduit:1>, <ore:chestWood>, <enderio:item_power_conduit:1>]]);
//x16 MV ceu
recipes.addShaped(<gregtech:machine:10672>, [[<ore:wireGtHexEnergeticAlloy>, <ore:circuitGood>, <ore:wireGtHexEnergeticAlloy>], [<enderio:item_power_conduit:1>, <meta_tile_entity:gregtech:hull.mv>, <enderio:item_power_conduit:1>], [<ore:wireGtHexEnergeticAlloy>, <ore:chestWood>, <ore:wireGtHexEnergeticAlloy>]]);
//x16 MV cef
recipes.addShaped(<gregtech:machine:10673>, [[<enderio:item_power_conduit:1>, <ore:circuitGood>, <enderio:item_power_conduit:1>], [<ore:wireGtHexEnergeticAlloy>, <meta_tile_entity:gregtech:hull.mv>, <ore:wireGtHexEnergeticAlloy>], [<enderio:item_power_conduit:1>, <ore:chestWood>, <enderio:item_power_conduit:1>]]);
...
assembler.findRecipe(7680, [<ore:circuitMaster>.firstItem * 4, <metaitem.quantumstar>], [<liquid:osmium> * 4608]).remove();
...
furnace.addRecipe(<ore:ingotWroughtIron>, <minecraft:iron_ingot>, 0.0);
	
//LV Casing
recipes.removeByRecipeName("gregtech:casing_lv");

// remove the steel plate assembler recipe for LV casing
assembler.findRecipe(16, [<ore:plateSteel> * 8, gt.getCirc(8)], [null]).remove();
...
//Wood Pulp
recipes.addShapeless(<gregtech:meta_item_1:2196> * 4,[<ore:logWood>,gt.mortar]);	

//Charcoal
furnace.addRecipe(<minecraft:coal:1>, <minecraft:log>, 0.0);

//Red Alloy Dust
recipes.addShapeless(<ore:dustRedAlloy>, [<ore:dustCopper>, <minecraft:redstone>, <minecraft:redstone>, <minecraft:redstone>, <minecraft:redstone>]);
...
for i, wrench in wrenches {
    ...
    recipes.addShaped("of_ulv_casing_wrench"+i, <gregtech:machine_casing>, [
        ...
        [<ore:plateElectricalSteel>,      wrench    , <ore:plateElectricalSteel>],
        [<ore:plateElectricalSteel>, <ore:plateElectricalSteel>, <ore:plateElectricalSteel>]]);
...
assembler.findRecipe(16,[<ore:plateWroughtIron> * 8, gt.getCirc(8)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateWroughtIron> * 2, gt.getCirc(2)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateIron> * 2, gt.getCirc(2)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateWroughtIron> * 6, gt.getCirc(6)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateIron> * 6, gt.getCirc(6)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateWroughtIron> * 7, gt.getCirc(7)], [null]).remove();	
assembler.findRecipe(4, [<ore:plateIron> * 7, gt.getCirc(7)], [null]).remove();	
assembler.findRecipe(2, [<ore:plateWroughtIron> * 5, <minecraft:chest>], [null]).remove();	
assembler.findRecipe(2, [<ore:plateIron> * 5, <minecraft:chest>], [null]).remove();	
assembler.findRecipe(4, [<ore:plateWroughtIron> * 4, <minecraft:redstone>], [null]).remove();	
assembler.findRecipe(4, [<ore:plateIron> * 4, <minecraft:redstone>], [null]).remove();	
...
assembler.recipeBuilder().inputs(<ore:plateElectricalSteel> * 3,<gregtech:machine_casing>,<ore:cableGtSingleRedAlloy> * 2).outputs([<gregtech:machine:500>]).duration(30).EUt(16).buildAndRegister();
