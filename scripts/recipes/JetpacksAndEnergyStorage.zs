...
recipes.addShaped(<simplyjetpacks:metaitemmods:8>, [
	[<ore:plateElectricalSteel>, <enderio:item_power_conduit>, <ore:plateElectricalSteel>],
	[<ore:plateElectricalSteel>, <enderio:item_material:14>, <ore:plateElectricalSteel>],
...
recipes.addShaped(<simplyjetpacks:metaitemmods:10>, [
	[<ore:plateVibrantAlloy>, <enderio:item_power_conduit:2>, <ore:plateVibrantAlloy>],
	[<ore:plateVibrantAlloy>, <enderio:item_material:19>, <ore:plateVibrantAlloy>],
	[<ore:plateRedAlloy>,<simplyjetpacks:metaitemmods:9>,<ore:plateRedAlloy>]]);
...
recipes.addShaped(<enderio:block_buffer:1>,  [
	[<ore:plateIron>, <ore:plateRedAlloy>, <ore:plateIron>],
...
recipes.addShaped(<enderio:block_cap_bank:1>,  [
	[<ore:plateDarkSteel>, <enderio:item_basic_capacitor>, <ore:plateDarkSteel>],
...
recipes.addShaped(vibrantjetpack, [
	[<ore:plateVibrantAlloy>,     compressedoctadiccap, <ore:plateVibrantAlloy>],
	[<ore:plateVibrantAlloy>,     energeticjetpack,     <ore:plateVibrantAlloy>],
...
alloy.recipeBuilder()
    .inputs([<ore:stickDarkSteel>,<enderio:item_material:20>])
...
alloy.recipeBuilder()
    .inputs([<enderio:item_material:1>,<ore:plateEndSteel> * 8])
...
recipes.addShaped(<enderio:block_franken_zombie_generator>, [
	...
	[<ore:gearElectricalSteel>, <ore:ingotSoularium>, <ore:gearElectricalSteel>]]);
...
recipes.addShaped(<enderio:block_vat>, [
	[<ore:plateDarkSteel>, <minecraft:cauldron>, <ore:plateDarkSteel>],
...
recipes.addShaped(<enderio:block_wired_charger>	, [
	[<ore:plateDarkSteel>, <appliedenergistics2:charger>, <ore:plateDarkSteel>],
...
recipes.addShaped(<enderio:item_coord_selector>	, [
	[<metaitem:emitter.mv>, <ore:blockEnderEye>, <ore:plateElectricalSteel>],
	[null, <enderio:item_material:13>, <ore:plateElectricalSteel>],
...
alloy.recipeBuilder()
    .inputs([<ore:gearIron>,<enderio:item_material:20> * 2])
...
recipes.addShaped(<enderio:block_travel_anchor>, [
	...
	[<ore:plateVibrantAlloy>,<enderio:item_material:14>,<ore:plateVibrantAlloy>],
	[<ore:plateDarkSteel>,<ore:plateVibrantAlloy>,<ore:plateDarkSteel>]]);
...
recipes.addShaped(<enderio:block_xp_vacuum>, [
	[<ore:plateDarkSteel>, <ore:plateDarkSteel>, <ore:plateDarkSteel>],
	[<ore:plateDarkSteel>, <enderio:item_xp_transfer>, <ore:plateDarkSteel>],
