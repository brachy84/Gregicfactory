...
furnace.addRecipe(<enderio:block_fused_glass>, <ore:blockGlass>, 0.0);
recipes.remove(<appliedenergistics2:spatial_pylon>);
recipes.addShaped(<appliedenergistics2:spatial_pylon>, [[<ore:plateNetherStar>, <moreplates:draconium_plate>, <ore:plateNetherStar>],[<moreplates:draconium_plate>, <draconicevolution:wyvern_energy_core>, <moreplates:draconium_plate>], [<ore:plateNetherStar>, <moreplates:draconium_plate>, <ore:plateNetherStar>]]);
...
// ??
//distillery.findRecipe(100, [gt.getCirc(0)], [<liquid:biomass> * 1000]).remove();	
//distillery.findRecipe(100, [gt.getCirc(0)], [<liquid:biomass> * 1000]).remove();	
//distillery.findRecipe(100, [gt.getCirc(1)], [<liquid:biomass> * 1000]).remove();	
distillery.findRecipe(100, [gt.getCirc(1)], [<liquid:biomass> * 1000]).remove();	
...
recipes.addShaped(<gregtech:machine:2198>, [[<ore:plateStainlessSteel>, <ore:plateStainlessSteel>, <ore:plateStainlessSteel>],[<ore:plateStainlessSteel>, <minecraft:bucket>, <ore:plateStainlessSteel>], [<ore:plateStainlessSteel>, <ore:plateStainlessSteel>, <ore:plateStainlessSteel>]]);
recipes.addShaped(<gregtech:machine:2199>, [[<ore:plateTitanium>, <ore:plateTitanium>, <ore:plateTitanium>],[<ore:plateTitanium>, <minecraft:bucket>, <ore:plateTitanium>], [<ore:plateTitanium>, <ore:plateTitanium>, <ore:plateTitanium>]]);
recipes.addShaped(<gregtech:machine:2197>, [[<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>],[<ore:plateSteel>, <minecraft:bucket>, <ore:plateSteel>], [<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>]]);
...
recipes.addShaped("test", <thermalexpansion:satchel:2>, [
	...
	[<ore:ingotAluminium>, <thermalexpansion:satchel:1>.marked("satchel"), <ore:ingotAluminium>], 
...
//Diamond Lens
lathe.findRecipe(16, [<ore:plateDiamond>.firstItem], [null]).remove();	
...
//Netherstar Lens
lathe.findRecipe(16, [<ore:plateNetherStar>.firstItem], [null]).remove();	
...
autoclave.recipeBuilder().inputs([<ore:blockGlass>]).fluidInputs([<liquid:water> * 1000]).outputs([<gregtech:meta_item_1:15209>]).duration(100).EUt(16).buildAndRegister();
...
//Enderpearl Lens
//lathe.findRecipe(16, [<ore:plateEnderPearl>], [null]).remove();	
...
recipes.addShaped(<gregtech:machine:515>, [
	...
	[gt.getCirc("HV"), <meta_tile_entity:gregtech:hull.mv>, gt.getCirc("HV")], 
	[<ore:pipeLargeStainlessSteel>, <gregtech:meta_item_1:32612>, <ore:pipeLargeStainlessSteel>]]);
...
lathe.recipeBuilder().inputs([<ore:stickNeutronium> * 2]).outputs([<gregtech:meta_item_2:19972>]).duration(200).EUt(30).buildAndRegister();
...
//Neutronium Round
recipes.remove(<ore:roundNeutronium>);	
lathe.findRecipe(8, [<gregtech:meta_item_1:9993>], [null]).remove();	
lathe.recipeBuilder().inputs([<avaritia:resource:3>]).outputs([<ore:roundNeutronium>.firstItem]).duration(5000).EUt(8).buildAndRegister();
...
brewer.findRecipe(3, [<metaitem:plant_ball>], [<liquid:for.honey> * 180]).remove();		
brewer.findRecipe(3, [<metaitem:plant_ball>], [<liquid:juice> * 180]).remove();		
...
brewer.recipeBuilder().inputs(<metaitem:plant_ball>).fluidInputs([<liquid:water> * 180]).fluidOutputs([<liquid:biomass> * 180]).duration(1440).EUt(3).buildAndRegister();
...
recipes.addShaped(<actuallyadditions:block_canola_press>, [
	[<ore:plateSteel>, <actuallyadditions:block_crystal:5>, <ore:plateSteel>], 
	[<metaitem:electric.piston.mv>, null, <metaitem:electric.piston.mv>], 
	[<ore:plateSteel>, <actuallyadditions:item_misc:8>, <ore:plateSteel>]]);
...
centrifuge.recipeBuilder().inputs(<ore:dustStone> * 3).outputs([<gregtech:meta_item_1:2159> * 2]).duration(40).EUt(20).buildAndRegister();


//Basic Transistor
recipes.addShaped(<metaitem:component.transistor> * 4, [
	[<gregtech:meta_item_1:19001>, <ore:plateRubber>, <gregtech:meta_item_1:19001>],
	[<gregtech:meta_item_1:19001>, <ore:plateRubber>, <gregtech:meta_item_1:19001>], 
	[<ore:wireFineSilver>, <ore:wireFineSilver>, <ore:wireFineSilver>]]);
	
//Basic Capacitor
recipes.addShaped(<metaitem:component.capacitor> * 4, [
	[<gregtech:meta_item_1:19189>, <ore:plateRubber>, <gregtech:meta_item_1:19189>],
	[<gregtech:meta_item_1:19189>, <ore:plateRubber>, <gregtech:meta_item_1:19189>], 
	[<ore:wireFineSilver>, null, <ore:wireFineSilver>]]);
...
assembler.recipeBuilder()
	.inputs([<ore:gearSteel> * 2, <ore:plateSteel> * 4, <gregtech:frame_steel>])
	.notConsumable(gt.getCirc(8))
	.outputs([<gregtech:turbine_casing:1> * 3])
	.duration(200).EUt(16).buildAndRegister();
assembler.recipeBuilder()
	.inputs([<ore:gearTitanium> * 2, <ore:plateTitanium> * 4, <ore:frameGtTitanium>])
	.outputs([<gregtech:turbine_casing:2> * 3])
	.duration(400).EUt(16).buildAndRegister();


//Engine Intake
assembler.recipeBuilder().inputs([<gregtech:meta_item_2:18072> * 4, <ore:pipeMediumTitanium> * 2, <gregtech:metal_casing:6>]).outputs([<gregtech:multiblock_casing>]).duration(400).EUt(16).buildAndRegister();
...
assembler.findRecipe(2, [<ore:plateWroughtIron>.firstItem * 5, <minecraft:trapped_chest>], [null]).remove();	
assembler.findRecipe(2, [<ore:plateIron>.firstItem * 5, <minecraft:trapped_chest>], [null]).remove();	
...
extruder.recipeBuilder().inputs([<avaritia:resource:4>]).notConsumable(<contenttweaker:smallgearextrudershape>).outputs([<ore:gearSmallNeutronium>.firstItem]).duration(130).EUt(64).buildAndRegister();			//neutronium small gear


recipes.addShaped(<enderio:item_material:41>, [
	[<enderio:item_alloy_ingot:7>,<minecraft:skull:2>,<enderio:item_alloy_ingot:7>],
	[<enderio:item_alloy_ingot:7>,gt.getCirc("MV"),<enderio:item_alloy_ingot:7>], 
...
reactor.findRecipe(480,
    [<ore:dustCarbon>.firstItem * 2, <gregtech:meta_item_1:2122>],
    [<liquid:chlorine> * 4000])
    .remove();

reactor.recipeBuilder()
    .inputs([<ore:dustCarbon> * 2, <gregtech:meta_item_1:2122>])
