...
recipes.addShaped(<contenttweaker:alloywidget>, [
	[<ore:wireGtDoubleCopper>, <ore:plateCupronickel>, <ore:wireGtDoubleCopper>],
	[<ore:plateCupronickel>, <ore:gearInvar>, <ore:plateCupronickel>], 
	[<ore:wireGtDoubleCopper>, <ore:plateCupronickel>, <ore:wireGtDoubleCopper>]]);


//Ender Widget
recipes.addShaped(<contenttweaker:enderwidget>, [
	[<enderio:item_item_conduit>, <ore:platePulsatingIron>, <enderio:item_redstone_conduit>],
	[<ore:platePulsatingIron>, <ore:gearElectricalSteel>, <ore:platePulsatingIron>], 
	[<enderio:item_power_conduit>, <ore:platePulsatingIron>, <enderio:item_liquid_conduit:1>]]);
