...
recipes.addShaped(<extendedcrafting:material:14>,
    [[<ore:plateBlackSteel>, <extendedcrafting:material:7>],
     [<gregtech:meta_item_1:12201>, <ore:plateIron>]]);
...
recipes.addShaped(<extendedcrafting:material:16>,
    [[<ore:plateBlackSteel>, <extendedcrafting:material:7>],
     [<ore:plateAluminium>, <ore:plateEnderPearl>]]);
...
craft.makeExtremeRecipe7(<contenttweaker:exoticmaterialscatalyst>,
    ...
    { A : <avaritia:resource:1>,
      ...
      J : <ore:ingotKanthal>,
      K : <ore:ingotMagnalium>,
      L : <ore:ingotNichrome>,
      M : <ore:ingotRedSteel>,
      N : <ore:ingotBlueSteel>,
      O : <ore:ingotVanadiumSteel>,
      P : <ore:ingotHssg>,
      Q : <ore:ingotHsse>,
      R : <ore:ingotHsss>,
      S : <ore:ingotManyullyn>,
      T : <ore:ingotStellite>,
...
recipes.addShaped(<avaritia:resource>, [
    [<ore:plateDiamond>, <minecraft:diamond_block>, <ore:plateDiamond>],
...
craft.makeExtremeRecipe9(<contenttweaker:ultimate_power_storage>,
    ...
    { A : doublecompressedoctadiccap,
      B : <metaitem:battery.re.lv.lithium>,
