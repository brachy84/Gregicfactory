...
assembler.recipeBuilder().inputs([<ore:plateIron> * 2]).notConsumable(gt.getCirc(2)).outputs([<minecraft:heavy_weighted_pressure_plate>]).duration(20).EUt(16).buildAndRegister();
